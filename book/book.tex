...
\documentclass[
    ...
    fontmethod=modern,   % unicode-math via lualatex; uses TeX Gyre Pagella
                         % (we patched kao.sty's modern path to use TeX Gyre
                         % Pagella + DejaVu instead of Libertinus, since
                         % Pagella ships with every TeX Live install).
]{kaobook}
...
\input{01_signals_as_vectors.tex}
\input{02_apriori_representations.tex}
\input{03_learned_representations.tex}
...
\input{generated/0b_why_cpp.tex}
